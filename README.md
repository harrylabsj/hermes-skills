...
| `token-cost-guard` | Realtime OpenClaw token cost monitoring with threshold alert reports. | `hermes skills install <owner>/hermes-skills/skills/token-cost-guard` |
